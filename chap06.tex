...
\begin{figure}[h!]
	...
	\caption{Sorting times of sequences of different sizes using quick sort (orange), selection sort (gray) and a combined function (blue).}
...
\begin{center}
	\begin{tabular}{|l|r|}
		...
		\textbf{Basic algorithm}    & 1059.10                                      \\ \hline
		\textbf{Strassen algorithm} & 873.89                                       \\ \hline
		\textbf{Combined (LR)}      & 818.98                                       \\ \hline
	\end{tabular}
\end{center}
\egroup
\caption{Total times of multiplying 80 pairs of square matrices of sizes 50-900.}
...
\begin{figure}[h!]
	...
	\centerline{
		\mbox{
			\includegraphics[width=110mm]{./img/matrix_mul_graph.png}
		}
	}
	\caption{Multiplication times of matrices of different sizes using basic algorithm (orange), Strassen algorithm (gray) and a combined function (blue).}
