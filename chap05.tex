...
To provide a more systematic and technical access of the framework behavior, a simple set of methods was made accessible on the \inlinecode{MultiFunctionN} type by extending two more traits, \inlinecode{MultiFunctionControl} and \inlinecode{MultiFunctionAnalytics}:
